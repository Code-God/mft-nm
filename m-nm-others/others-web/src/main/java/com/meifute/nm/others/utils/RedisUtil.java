...
public class RedisUtil {
    ...
    public synchronized static boolean set(String key, String value, long time) {
        try {
            if (time > 0) {
    ...
    public synchronized static void setHashMap(String key,String hKey,String hValue) {
        staticRedisTemplate.opsForHash().put(key,hKey,hValue);
    }
     ...
     * 批量插入key,value值
     */
    public static void setRedisMulti(Map<String,String> map) {
         staticRedisTemplate.opsForValue().multiSet(map);
    }
