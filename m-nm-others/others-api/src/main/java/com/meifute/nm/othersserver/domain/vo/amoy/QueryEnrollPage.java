 ...
 */
@Data
public class QueryEnrollPage implements Serializable {
    ...
    private Integer someoneNumber;
    @ApiModelProperty(value = "签到记录")
    private List<AmoySignin> amoySignins;
    @ApiModelProperty(value = "报名时的达标名额")
    private Integer enrollNextAgentNumber;
    @ApiModelProperty(value = "活动结束时的达标数")
    private Integer activityEndAgentNumber;
}
